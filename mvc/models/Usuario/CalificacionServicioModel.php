...
class CalificacionServicioModel extends Model {
    ...
    public function setCalificacion($viajeSelected){
        ...
        $calificacion->RegistrarCalificacion($viajeSelected['ViajeID'], $viajeSelected['ClienteID'],$viajeSelected['ChoferID'],"'$this->puntaje'","'$fechaCalificacion'", "'$this->comentario'", $viajeSelected['AgenciaID']);
        return true;
