...
class ActualizarClienteModel extends Model {
    ...
    public $actualizar_ClienteError;
    ...
    public function actualizarCliente($ClienteID)
    {
        try {
            ...
            $persona = $model->ModificarPersona($ClienteID,"'$this->nombre'","'$this->apellido'","'$this->usuario'","'$this->contrasenia'","'$this->telefono'","'$this->correo'","'$this->direccion'","'$this->coordenadas'",0,0,1,4,"'$this->documento'",$agenciaID); //genera el alta del usuario y lo guarda
            ...
            $this->addError('actualizar_ClienteError',$messageError);
            return false;
        }
    }
    public function setAtributos($clienteSelected)
    {
        $this->nombre=$clienteSelected['Nombre'];
        $this->apellido=$clienteSelected['Apellido'];
        $this->correo=$clienteSelected['Email'];
        $this->telefono=$clienteSelected['Telefono'];
        $this->documento=$clienteSelected['Documento'];
        $this->direccion=$clienteSelected['Direccion'];
        $this->coordenadas=$clienteSelected['DireccionCoordenada'];
        $this->usuario=$clienteSelected['Usuario'];
        $this->estado=$clienteSelected['Estado'];
        $this->contrasenia=$clienteSelected['Password'];
        $this->confirmarContrasenia=$clienteSelected['Password'];
    }
}
