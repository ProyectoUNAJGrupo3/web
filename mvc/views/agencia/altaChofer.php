            ...
            <article>
                <div id="page-single-main">
                    ...
                    <div class="container-form" id="contenedor-formulario">
                        ...
                        <br />
                        <?= $form->field($model, 'usuario')->textInput()->label("Usuario <b id='asterisco'>*</b>"); ?>
                        <?= $form->field($model, 'contrasenia')->passwordInput()->label("Contrase&ntilde;a <b id='asterisco'>*</b>"); ?>
                        <?= $form->field($model, 'confirmarContrasenia')->passwordInput()->label("Confirmar Contrase&ntilde;a <b id='asterisco'>*</b>"); ?>
